    ...
    <>
      ...
      <div className="row py-5">
        ...
        {trendingTv.slice(0, 10).map((tv, index) => (
           <Link to={'/MovieDetails/'+tv.id+'/'+tv.media_type} className="col-md-2">
            <div className="tv position-relative">
              <img
                ...
                alt="tv poster"
              ></img>
              <h6 className="mt-2 text-center">{tv.name}</h6>
              <div className="vote p-2 text-center position-absolute top-0 end-0 "> {tv.vote_average.toFixed(1)}</div>
            </div>
           </Link>
        ))}
      </div>
      ...
      <div className="row py-5" >
        ...
        {trendingPerson.slice(0, 10).map((person, index) => (
           <Link to={'/MovieDetails/'+person.id+'/'+person.media_type} className="col-md-2">
